<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Identitas_kendaraan extends Site_utils {
		...
		function sync_data($no_polisi=''){
			...
			//$url = 'http://192.168.99.13/bapenda_rest/simka/get_info_kbm/?';
			...
			try{
				...
				//CURLOPT_URL => 'http://puslia.jabarprov.go.id/bapenda_rest/index.php/simka/get_info_kbm/?no_polisi=D1479VBO&kode_plat=1',
				...
				//$curl = curl_init();
				//curl_setopt_array($curl, array(
				//CURLOPT_URL => $url. 'no_polisi=' .$no_polisi. '&kode_plat=' .$kd_plat,
				//CURLOPT_RETURNTRANSFER => true,
				//CURLOPT_SSL_VERIFYPEER => FALSE,
				//CURLOPT_SSL_VERIFYHOST => 2,
				//CURLOPT_ENCODING => '',
